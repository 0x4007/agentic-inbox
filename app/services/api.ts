...
const api = {
	...
	backfillGmail: (pageToken?: string, force = false) =>
	...
	makeDraft: (messageId: string) => post<{ status: string; replyId?: string; error?: string }>("/api/v1/gmail/regenerate-draft", { messageId }),
